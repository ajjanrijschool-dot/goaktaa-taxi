...
window.I18N = (function () {
  ...
  var DICT = {
    ...
    en: {
      ...
      'hero.photo.caption': 'The car and the driver waiting for you at Arrivals 4. What the ride costs comes off the taximeter when you get there — there is no price to agree first.',
      ...
      'form.subb': 'Your name goes on the card at Arrivals 4.',
      ...
      'reviews.ask': 'Rode with us? Tell us how it went and it goes straight on this page.',
      'reviews.cta': 'Send us your review',
    ...
    nl: {
      ...
      'hero.photo.caption': 'De auto en de chauffeur die bij Aankomsthal 4 op je wachten. Wat de rit kost komt van de taxameter zodra je er bent — vooraf valt er geen prijs af te spreken.',
      ...
      'form.subb': 'Jouw naam komt op het bordje bij Aankomsthal 4.',
      ...
      'reviews.ask': 'Met ons meegereden? Laat weten hoe het ging en het komt op deze pagina.',
      'reviews.cta': 'Stuur je beoordeling',
    ...
    ar: {
      ...
      'hero.photo.caption': 'السيارة والسائق في انتظارك عند مخرج الوصول 4. تكلفة الرحلة تظهر على العدّاد عند الوصول — ولا سعر يُتفق عليه مسبقاً.',
      ...
      'form.subb': 'اسمك سيكون على اللوحة عند مخرج الوصول 4.',
      ...
      'reviews.lede': 'بدأنا العمل حديثاً. كثير من مواقع التاكسي تبدأ بعبارات مدح من أشخاص لا وجود لهم؛ هذه الصفحة ستعرض تقييمات حقيقية أو لا تعرض شيئاً.',
      'reviews.ask': 'رَكِبت معنا؟ أخبرنا كيف كانت الرحلة وسننشرها هنا.',
      'reviews.cta': 'أرسل تقييمك',
