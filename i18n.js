...
window.I18N = (function () {
  ...
  var DICT = {
    ...
    en: {
      ...
      'reviews.title': 'How was the ride?',
      'reviews.ask': 'Rode with us? Tell us how it went.',
      'reviews.rating': 'Your rating',
      'reviews.name': 'Your name',
      'reviews.words': 'Your review',
      'reviews.words.ph': 'What went well, what could be better',
      'reviews.send': 'Send review',
      'reviews.note': 'We read every one. Published with your first name only, and only with your words.',
      'reviews.thanks': 'Thank you — that reached us.',
      'reviews.none': 'No reviews published yet. Yours would be the first.',
      'reviews.err.rating': 'Pick a rating first.',
      'reviews.err.name': 'A first name is enough.',
      'reviews.err.words': 'Tell us a little more.',
    ...
    nl: {
      ...
      'reviews.title': 'Hoe was de rit?',
      'reviews.ask': 'Met ons meegereden? Laat weten hoe het ging.',
      'reviews.rating': 'Je beoordeling',
      'reviews.name': 'Je naam',
      'reviews.words': 'Je beoordeling',
      'reviews.words.ph': 'Wat ging goed, wat kan beter',
      'reviews.send': 'Verstuur beoordeling',
      'reviews.note': 'We lezen ze allemaal. Geplaatst met alleen je voornaam, en alleen in jouw woorden.',
      'reviews.thanks': 'Bedankt — die is bij ons aangekomen.',
      'reviews.none': 'Nog geen beoordelingen geplaatst. De jouwe zou de eerste zijn.',
      'reviews.err.rating': 'Kies eerst een beoordeling.',
      'reviews.err.name': 'Een voornaam is genoeg.',
      'reviews.err.words': 'Vertel iets meer.',
    ...
    ar: {
      ...
      'reviews.title': 'كيف كانت الرحلة؟',
      'reviews.ask': 'رَكِبت معنا؟ أخبرنا كيف كانت.',
      'reviews.rating': 'تقييمك',
      'reviews.name': 'اسمك',
      'reviews.words': 'رأيك',
      'reviews.words.ph': 'ما الذي كان جيداً، وما الذي يمكن تحسينه',
      'reviews.send': 'أرسل التقييم',
      'reviews.note': 'نقرأ كل تقييم. يُنشر باسمك الأول فقط، وبكلماتك أنت.',
      'reviews.thanks': 'شكراً — وصلنا تقييمك.',
      'reviews.none': 'لا توجد تقييمات منشورة بعد. تقييمك سيكون الأول.',
      'reviews.err.rating': 'اختر تقييماً أولاً.',
      'reviews.err.name': 'الاسم الأول يكفي.',
      'reviews.err.words': 'أخبرنا بالمزيد قليلاً.',
