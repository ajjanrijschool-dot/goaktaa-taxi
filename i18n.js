...
window.I18N = (function () {
  ...
  var DICT = {
    ...
    en: {
      ...
      'err.datePart': 'That date is not complete — fill in day, month and year.',
      'err.timePart': 'That time is not complete — check the AM or PM part too.',
    ...
    nl: {
      ...
      'err.datePart': 'Die datum is niet compleet — vul dag, maand en jaar in.',
      'err.timePart': 'Die tijd is niet compleet — controleer ook het AM/PM-deel.',
    ...
    ar: {
      ...
      'err.datePart': 'التاريخ غير مكتمل — أدخل اليوم والشهر والسنة.',
      'err.timePart': 'الوقت غير مكتمل — تأكد من خانة AM أو PM أيضاً.',
