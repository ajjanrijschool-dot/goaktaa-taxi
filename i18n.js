...
window.I18N = (function () {
  ...
  var DICT = {
    ...
    en: {
      ...
      'fare.tag': 'Fare',
      'fee.bar': 'booking fee, paid online. The ride itself runs on the taximeter.',
      'fee.due': 'Booking fee due',
      'fee.explain': 'Your ride is only held once this is paid. The fare itself is settled in the car, on the meter.',
      'fee.pay': 'Pay €20 and confirm',
      'fare.note': 'A €20 booking fee confirms the ride, paid online now. The ride itself is on the taximeter: your driver starts it at pickup and you pay what it reads at the door, within the national maximum taxi tariff. No surge pricing.',
      'form.submit': 'Request this ride',
      'form.sending': 'Sending…',
      'form.note': 'The €20 booking fee is paid on the next screen. The fare itself is settled in the car.',
    ...
    nl: {
      ...
      'fare.tag': 'Tarief',
      'fee.bar': 'boekingskost, online te betalen. De rit zelf gaat op de taxameter.',
      'fee.due': 'Te betalen boekingskost',
      'fee.explain': 'Je rit staat pas vast als dit betaald is. Het ritbedrag reken je in de auto af, op de meter.',
      'fee.pay': 'Betaal €20 en bevestig',
      'fare.note': 'Een boekingskost van €20 bevestigt de rit, nu online te betalen. De rit zelf gaat op de taxameter: je chauffeur start hem bij het instappen en je betaalt wat er bij de deur op staat, binnen het landelijke maximumtarief. Geen piektarief.',
      'form.submit': 'Deze rit aanvragen',
      'form.sending': 'Versturen…',
      'form.note': 'De boekingskost van €20 betaal je op het volgende scherm. Het ritbedrag reken je in de auto af.',
    ...
    ar: {
      ...
      'fare.tag': 'الأجرة',
      'fee.bar': 'رسوم حجز تُدفع عبر الإنترنت. أما الرحلة نفسها فبالعدّاد.',
      'fee.due': 'رسوم الحجز المستحقة',
      'fee.explain': 'لا تُحجز رحلتك إلا بعد دفع هذا المبلغ. أما الأجرة فتُدفع في السيارة على العدّاد.',
      'fee.pay': 'ادفع 20 يورو وأكّد',
      'fare.note': 'رسوم حجز قدرها 20 يورو تؤكد الرحلة، تُدفع الآن عبر الإنترنت. أما الرحلة نفسها فبالعدّاد: يشغّله السائق عند الركوب وتدفع القراءة عند الوصول، ضمن الحد الأقصى للتعريفة الوطنية. وبلا أسعار مضاعفة.',
      'form.submit': 'أرسل طلب الرحلة',
      'form.sending': 'جارٍ الإرسال…',
      'form.note': 'رسوم الحجز 20 يورو تُدفع في الشاشة التالية. أما الأجرة فتُدفع داخل السيارة.',
